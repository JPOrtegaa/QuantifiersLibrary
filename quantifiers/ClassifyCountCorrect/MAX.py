...
if __name__ == '__main__':
    ...
    max_qtf.fit(X_trainn, y_trainn)
    class_distribution = max_qtf.predict(X_testt)

    print(max_qtf.classifier.classes_)
